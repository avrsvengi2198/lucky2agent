...
//   server1 	= 'http://elanciereschool.in/lucky/app/agent';.
  ...
  constructor(private httpClient:HttpClient,private router:Router) { 
	...
	newticketList(details):Observable<any>{
		return this.httpClient.post<any>(this.server+'/buyLottery.php', details, this.httpOptions).pipe(retry(0),catchError(this.errorHandl)); 
	}
